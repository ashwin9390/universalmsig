...
- ⚠️ CoreML model execution needs macOS (compile works on Linux)
- ⚠️ QNN real hardware needs AI Hub token (see Option D)
...
3. Configure token:
   ...
   ```
4. Run: `msig-translate --model Qwen/Qwen2.5-0.5B --target qnn --out ./out`
