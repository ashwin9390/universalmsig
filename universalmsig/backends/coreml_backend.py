...
class CoreMLBackend(BaseBackend):
    ...
    Produces:
       <model>_coreml_spec.json     F model spec for inspection / debugging
       <model>_mil_graph.py         F executable MIL graph Python script
       <model>.mlpackage            F compiled CoreML bundle (needs coremltools)
    """
